...
```
git clone https://github.com/parikshiti/HOSPITAL-AI.git
```
...
mongoose.connect("mongodb://admin:admin123@ds263816.mlab.com:63816/be-hospital"); to mongoose.connect("your-database-link");
